...
public class ControllerAdvisor extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleStudentNameNotFoundException(StudentNameNotFoundException ex, WebRequest request) {

		Map<String, Object> body = new LinkedHashMap<>();
		body.put("timestamp", LocalDateTime.now());
		body.put("message", "student Name not found");
